...
return [
    ...
    */
	...
	'custom' => [
		...
		'phone' => [
			'regex' => 'users_phone_regex',
			'required' => 'users_phone_required',
			'required_without' => 'users_phone_required_without',
			'max' => 'users_phone_max',
		...
		'gender' => [
			'required' => 'users_gender_required',
			'boolean' => 'users_gender_boolean'
		],
		'dateOfBirth' => [
			'required' => 'users_dateOfBirth_required',
			'date_format' => 'users_dateOfBirth_date_format'
		],
		'about' => [
			'required' => 'users_about_required',
			'max' => 'users_about_max',
			'string' => 'users_about_string'
		],
		'status' => [
			'boolean' => 'request_status_boolean',
			'in' => 'request_status_in'
		],
	],
